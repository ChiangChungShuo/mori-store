  ...
  },
  {
    ...
    items: [
      { q: '可以退換貨嗎？', a: <div className="faq-policy-copy">
        <strong>✓ 購買前請確認下列資訊，同意再行購買</strong>
        <p>購買前請確認尺寸、顏色、款式與商品描述。闆闆在包裝寄送前會仔細核對訂單並檢查衣服狀況；若發現瑕疵或品質未達標準，會主動留言確認退貨退款或更換方式。</p>
        <p>若商品有瑕疵，建議於收到商品後 3 日內透過訂購系統、Instagram 或客服信箱告知並附上照片，以便優先處理；提出申請後請配合於 7 日內寄回。</p>
        <strong>✓ 退回商品須保持完整</strong>
        <ul>
          <li>不得有非檢查必要的氣味、穿戴痕跡、髒污、洗滌、下水或剪標。</li>
          <li>商品、吊牌、原包裝與贈品須保持完整新品狀態。</li>
          <li>尚未出貨前可留言詢問是否有現貨尺寸可修改；出貨後需換尺寸，請先聯絡客服並重新下單。</li>
          <li>不提供因個人喜好任意換款或換色；收到錯誤款式或顏色者不在此限。</li>
          <li>新品布料或染劑氣味通風後會逐漸散去，單純氣味不列為瑕疵。</li>
          <li>店到店逾期未領遭退回，重新寄送運費由買方負擔。</li>
        </ul>
        <p>依消費者保護法，通訊交易原則上仍享有到貨後 7 日解除權；以上通知與換貨流程不限制法定權利。</p>
      </div> },
