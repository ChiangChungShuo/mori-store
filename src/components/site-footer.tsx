  ...
  return (
    <footer className="site-footer-shell">
      <div className="site-footer">
        ...
        <section className="footer-service"><strong>配送與服務</strong><p>7-ELEVEN／全家<br />台灣本島超商取貨</p><p>客服時間<br />週一至週五 10:00–18:00</p><div className="footer-payments"><span>銀行匯款</span></div></section>
      </div>
